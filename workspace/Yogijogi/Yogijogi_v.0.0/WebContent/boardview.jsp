		...
		<div class="board_wrap">
			...
			<div class="comment_wrap">
				...
				<div class="comment_write">
					...
					<form id="myForm" name="comment" method="get" action="./boardview.jsp" onsubmit="return FormCheck('comment')">
						<input type="hidden" name="no" value="1">
						<textarea id="post" name="post" placeholder="댓글을 입력하세요"></textarea>
