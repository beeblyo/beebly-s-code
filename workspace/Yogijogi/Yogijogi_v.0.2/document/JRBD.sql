...
insert into member(mid,mpw,mname,memail,memailcheck,mpnum,mhost) values('lee1234',md5('12345'),'이순신','lee@gmail.com',true,'010-1234-5678','Y');
...
(
	...
	corgNm varchar(250),
	cplace varchar(250),
	cstartDay varchar(250),
	csubject varchar(250),
	curl varchar(250)
);
